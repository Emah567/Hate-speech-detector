...
<div className="Icons">
  ...
  <rect width="80.0866" height="69.5489" rx="17.5189" fill="#292929"/>
  ...
  <span className="icon">
  <svg xmlns="http://www.w3.org/2000/svg" width="81" height="70" viewBox="0 0 81 70" fill="none">
  <rect x="0.108154" width="80.0866" height="69.5489" rx="17.5189" fill="#292929"/>
  ...
  <span className="icon">
  <svg  id="svg"xmlns="http://www.w3.org/2000/svg" width="81" height="70" viewBox="0 0 81 70" fill="none">
  <rect x="0.216431" width="80.0866" height="69.5489" rx="17.5189" fill="#292929"/>
...
<h2> Or</h2>
  <div className="strokeLength"> <svg xmlns="http://www.w3.org/2000/svg" width="86" height="2" viewBox="0 0 86 2" fill="none">
  <path d="M0 1H86" stroke="#878787"/>
</svg></div>
</div>
        <div className="form">
     ...
     <input type="password" id="password" name="password" placeholder="Enter your password"    onChange={handlechange}
        ...
        <div className="link">
    Already have an account  <Link to="/LoginScreen">  Login here</Link>
</div>
        </div>
